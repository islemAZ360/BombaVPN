TRANSLATIONS = {
    ...
    'ar': {
        ...
        'ReferralDesc': 'انسخ هذا الرابط وأرسله لأصدقائك. إذا سجل صديقك واشترى اشتراكاً، ستحصلان <strong>كلاكما</strong> على <strong>7 أيام مجانية</strong> تضاف لآخر اشتراك قمت بشرائه! ملاحظة: لا يمكنك إرسال أو استقبال مكافأة الإحالة إلا بعد شراء اشتراك واحد على الأقل.',
        'CopyBtn': 'نسخ الرابط',
    ...
    'ru': {
        ...
        'ReferralDesc': 'Скопируйте эту ссылку и отправьте друзьям. Если ваш друг зарегистрируется и купит подписку, <strong>ОБА</strong> из вас автоматически получите <strong>7 бесплатных дней</strong> к вашей последней подписке! Примечание: Вы не можете получать или отправлять реферальные награды, пока не купите хотя бы одну подписку.',
        'CopyBtn': 'Копировать',
