TRANSLATIONS = {
    'en': {
        ...
        'ReferralDesc': 'Copy this link and send it to your friends. If your friend registers and buys a subscription, you will automatically get <strong>7 free days</strong> added to your subscription!',
        'CopyBtn': 'Copy Link',
    ...
    'ar': {
        ...
        'ReferralDesc': 'انسخ هذا الرابط وأرسله لأصدقائك. إذا سجل صديقك واشترى اشتراكاً، ستحصل تلقائياً على <strong>7 أيام مجانية</strong> تضاف لاشتراكك!',
        'CopyBtn': 'نسخ الرابط',
    ...
    'ru': {
        ...
        'ReferralDesc': 'Скопируйте эту ссылку и отправьте друзьям. Если ваш друг зарегистрируется и купит подписку, вы автоматически получите <strong>7 бесплатных дней</strong>!',
        'CopyBtn': 'Копировать',
