TRANSLATIONS = {
    ...
    'ru': {
        ...
        'ReferralDesc': 'Скопируйте эту ссылку и отправьте друзьям. Если ваш друг зарегистрируется и купит подписку, вы автоматически получите <strong>7 бесплатных дней</strong> к вашей подписке!',
